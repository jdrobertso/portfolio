        ...
        >
          {status === "done" ? (
            ...
            >
              <div
                className="mono"
                style={{ color: "var(--green-primary)", fontSize: "0.85rem", marginBottom: "0.5rem" }}
              >
                $ message --sent ✓
              </div>
              ...
              {FIELDS.map((field, fi) => (
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ color: focused === field.id ? "var(--green-primary)" : "var(--text-secondary)" }}>
                      export
                    </span>{" "}
                    {field.label}=
                  </label>
                  {field.type === "textarea" ? (
                    <textarea
                      ...
                      style={{
                        width: "100%",
                        background: "var(--bg-card)",
                        border: `1px solid ${focused === field.id ? "var(--green-primary)" : "var(--border)"}`,
                        color: "var(--text-primary)",
                        padding: "10px 14px",
